        ...
        <div className='mx-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-12 px-6 py-8 gap-6 md:gap-0 lg:px-36 lg:py-36'>
                <div className='lg:col-span-7 flex flex-col justify-center items-center gap-5 lg:gap-12'>
                    ...
                    <a className="px-4 py-2 lg:px-6 lg:py-3 rounded-lg hover:scale-105 cursor-pointer transition text-white ws font-semibold lg:text-lg ws  bg-[#23BE0A] ">View The List </a>
                </div>
