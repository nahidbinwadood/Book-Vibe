...
const About = () => {
    return (
        <div className="container pb-10 md:pb-20 md:pt-10 mx-auto mt-10 px-5 lg:px-0">
                                    ...
                                    <form action="#" method="POST" className="mt-4">
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <Link className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-[#59C6D2] border border-transparent rounded-md focus:outline-none hover:bg-[#59C6D2] focus:bg-[#59C6D2]">Send Message</Link>
                                            </div>
                                        </div>
                                    </form>
                                </div>
