...
import { saveBooks,saveWishedBooks } from "../../../Components/Utils/local";
            ...
            <div className="grid grid-cols-1 gap-8 md:gap-24 md:grid-cols-2">
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex gap-6">
                        <a onClick={()=>handleRead(currentBook)} className="px-4 py-2 lg:px-6 lg:py-3 rounded-lg hover:scale-105 cursor-pointer transition text-black ws font-semibold lg:text-lg bg-transparent border border-gray-400">Read </a>
                        <a onClick={()=>handleWishlist(currentBook)} className="px-4 py-2 lg:px-6 lg:py-3 rounded-lg hover:scale-105 cursor-pointer transition text-white ws font-semibold lg:text-lg bg-[#50B1C9] ">Wishlist </a>
                    </div>
                </div>
